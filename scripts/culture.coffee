...
culturalMsgs = [
  ...
  '<a href=\'https://www.khanacademy.org/wtf\'>Why are we building what we\'re building? What are we building? Who is doing what?</a>'
  '<a href=\'https://sites.google.com/a/khanacademy.org/forge/for-developers/performance\'>Performance is a feature</a> and is everyone\'s job. Unsure how to profile your code? No worries, just ask, we have some perf nuts on the team.'
...
morningCultureHour = 10
# hour of morning (pacific time) at which to send
...
msUntilMorning = ->
  ...
  later = new Date
  pacificUTCOffset = 7
  # not worrying about DST for now
...
module.exports = (robot) ->
  ...
  sendCultureMessage = (msg) ->
    urlCultureCowEmoticon = 'https://dujrsrsgsd3nh.cloudfront.net/img/emoticons/6574/culture-1376771657.png'
    s =  urlCultureCowEmoticon + ' ' + culturalMsgs[msgIndex] + ' Moooo.'
    #genesisDevice =
      #'msg': s
      #'room': if msg then msg.envelope.room else null
      #'color': 'purple'
      #'from': 'Culture Cow'
  ...
  robot.respond /culture us$/i, (msg) ->
    sendCultureMessage msg
    return
